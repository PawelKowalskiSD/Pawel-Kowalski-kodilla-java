...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://pawelkowalskisd.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kowalski.pawel.sd@gmail.com");
        WebElement el = driverTrello.findElement(By.id("login"));
        el.click();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("JavaTest123!@");
